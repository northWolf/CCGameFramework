...
export default class ObjectPool {
     ...
     * @return Object
     */
    public static pop(classZ: any, classKey: string, ...args: any[]): any {
        if (!ObjectPool._content[classKey]) {
            ObjectPool._content[classKey] = [];
        }

        var list: Array<any> = ObjectPool._content[classKey];
        if (list.length) {
            return list.pop();
        } else {
     ...
     * @returns {any}
     */
    public static popWithExtraKey(refKey: any, extraKey: any): any {
     ...
     */
    public static clearClass(classKey: string, clearFuncName: string = null): void {
        var list: Array<any> = ObjectPool._content[classKey];
