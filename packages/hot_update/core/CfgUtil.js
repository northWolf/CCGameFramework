let fs = require("fire-fs"), path = require("fire-path"), electron = require("electron"),
    FileUtil = Editor.require("packages://hot_update/core/FileUtil"), self = module.exports = {
        cfgData: {
            version: "",
            serverRootDir: "",
            resourceRootDir: "",
            ...
            if (fs.existsSync(t)) {
                let i = fs.readFileSync(t, "utf-8"), r = JSON.parse(i);
            ...
            let e = {buildTime: null, genTime: null}, t = this._getAppCfgPath();
            if (fs.existsSync(t)) {
                let i = fs.readFileSync(t, "utf-8"), r = JSON.parse(i);
            ...
            this.cfgData.version = e.version, this.cfgData.serverRootDir = e.serverRootDir, this.cfgData.resourceRootDir = e.resourceRootDir, this.cfgData.localServerPath = e.localServerPath, this.cfgData.hotAddressArray = e.hotAddressArray, this._save()
        }, _save() {
