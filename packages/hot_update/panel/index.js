...
args.releasePath              = path.join(Editor.Project.path, "build/web-desktop/");                               // 发布资源文件路径
...
args.releaseCdnPath           = path.join(Editor.Project.path, "../game-slots-update/update/", config.line, "/");   // 发布到ＣＮＤ路径
args.releaseVersionConfigPath = path.join(Editor.Project.path, "../game-slots-update-version/constinfo/version.json");         // 发布的所有模块版本信息
